...
export DEST_ROOT=$SCRATCH/demo_data
export DEST=$DEST_ROOT/reg/d/psdm/cxi/cxid9114
export THREADS=32

# /global/project/projectdirs/lcls/d/psdm/cxi/cxid9114/demo/test_xtc
...
( cd $SRC/demo/test_xtc && find . -maxdepth 1 -name '*-r0108-*' -print0 | xargs -0 -n1 -P$THREADS -I% rsync -a % $DEST/xtc/% )
( cd $SRC/demo/test_xtc/smalldata && find . -maxdepth 1 -name '*-r0108-*' -print0 | xargs -0 -n1 -P$THREADS -I% rsync -a % $DEST/xtc/smalldata/% )
